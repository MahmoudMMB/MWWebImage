...
typedef NSURLResponse * _Nullable (^MWWebImageDownloaderResponseModifierBlock)(NSURLResponse * _Nonnull response);
 ...
 */
@protocol MWWebImageDownloaderResponseModifier <NSObject>
...
/// @note If nil is returned, the image download will marked as cancelled with error `MWWebImageErrorInvalidDownloadResponse`
 ...
 */
@interface MWWebImageDownloaderResponseModifier : NSObject <MWWebImageDownloaderResponseModifier>

/// Create the response modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull MWWebImageDownloaderResponseModifierBlock)block;

/// Create the response modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)responseModifierWithBlock:(nonnull MWWebImageDownloaderResponseModifierBlock)block;
...
*/
@interface MWWebImageDownloaderResponseModifier (Conveniences)
