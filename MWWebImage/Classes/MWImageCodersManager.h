...
/**
 ...
 Coders
 ------
 A coder must conform to the `MWImageCoder` protocol or even to `MWProgressiveImageCoder` if it supports progressive decoding
 ...
 */
@interface MWImageCodersManager : NSObject <MWImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) MWImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<MWImageCoder>> *coders;
