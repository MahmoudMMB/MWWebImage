...
@interface MWWebImageDownloaderRequestModifier ()

@property (nonatomic, copy, nonnull) MWWebImageDownloaderRequestModifierBlock block;

@end

@implementation MWWebImageDownloaderRequestModifier

- (instancetype)initWithBlock:(MWWebImageDownloaderRequestModifierBlock)block {
    self = [super init];
    if (self) {
        self.block = block;
    }
...
+ (instancetype)requestModifierWithBlock:(MWWebImageDownloaderRequestModifierBlock)block {
    MWWebImageDownloaderRequestModifier *requestModifier = [[MWWebImageDownloaderRequestModifier alloc] initWithBlock:block];
...
@implementation MWWebImageDownloaderRequestModifier (Conveniences)
