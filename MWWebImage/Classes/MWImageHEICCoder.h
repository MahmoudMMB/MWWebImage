...
/**
 ...
 @note If you need to support lower firmware version for HEIF, you can have a try at https://github.com/MWWebImage/MWWebImageHEIFCoder
 */
API_AVAILABLE(ios(13.0), tvos(13.0), macos(10.15), watchos(6.0))
@interface MWImageHEICCoder : MWImageIOAnimatedCoder <MWProgressiveImageCoder, MWAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) MWImageHEICCoder *sharedCoder;
