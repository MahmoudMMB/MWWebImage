 ...
 */
@interface MWImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<MWImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<MWImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage NS_SWIFT_NAME(frames(from:));
