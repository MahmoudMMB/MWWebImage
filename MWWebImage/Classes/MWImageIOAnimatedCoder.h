 ...
 */
@interface MWImageIOAnimatedCoder : NSObject <MWProgressiveImageCoder, MWAnimatedImageCoder>

#pragma mark - Subclass Override
/**
 The supported animated image format. Such as `MWImageFormatGIF`.
 @note Subclass override.
 */
@property (class, readonly) MWImageFormat imageFormat;
/**
 The supported image format UTI Type. Such as `kUTTypeGIF`.
 This can be used for cases when we can not detect `MWImageFormat. Such as progressive decoding's hint format `kCGImageSourceTypeIdentifierHint`.
 @note Subclass override.
 */
