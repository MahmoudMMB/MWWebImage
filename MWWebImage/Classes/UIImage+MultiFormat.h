...
/**
 ...
 @note If the receiver is `MWAnimatedImage`, this will return the animated image data if available. No more extra encoding process.
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)MW_imageDataAsFormat:(MWImageFormat)imageFormat NS_SWIFT_NAME(MW_imageData(as:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)MW_imageDataAsFormat:(MWImageFormat)imageFormat compressionQuality:(double)compressionQuality NS_SWIFT_NAME(MW_imageData(as:compressionQuality:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)MW_imageDataAsFormat:(MWImageFormat)imageFormat compressionQuality:(double)compressionQuality firstFrameOnly:(BOOL)firstFrameOnly NS_SWIFT_NAME(MW_imageData(as:compressionQuality:firstFrameOnly:));
