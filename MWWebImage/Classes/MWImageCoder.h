...
typedef NSString * MWImageCoderOption NS_STRING_ENUM;
typedef NSDictionary<MWImageCoderOption, id> MWImageCoderOptions;
typedef NSMutableDictionary<MWImageCoderOption, id> MWImageCoderMutableOptions;
...
/**
 ...
 @note works for `MWImageCoder`.
 */
FOUNDATION_EXPORT MWImageCoderOption _Nonnull const MWImageCoderDecodeFirstFrameOnly;
...
/**
 ...
 @note works for `MWImageCoder`, `MWProgressiveImageCoder`, `MWAnimatedImageCoder`.
 */
FOUNDATION_EXPORT MWImageCoderOption _Nonnull const MWImageCoderDecodeScaleFactor;
...
/**
 ...
 @note works for `MWImageCoder`, `MWProgressiveImageCoder`, `MWAnimatedImageCoder`.
 */
FOUNDATION_EXPORT MWImageCoderOption _Nonnull const MWImageCoderDecodePreserveAspectRatio;
...
/**
 ...
 @note works for `MWImageCoder`, `MWProgressiveImageCoder`, `MWAnimatedImageCoder`.
 */
FOUNDATION_EXPORT MWImageCoderOption _Nonnull const MWImageCoderDecodeThumbnailPixelSize;
...
/**
 ...
 @note works for `MWImageCoder`.
 */
FOUNDATION_EXPORT MWImageCoderOption _Nonnull const MWImageCoderEncodeFirstFrameOnly;
/**
 ...
 @note works for `MWImageCoder`
 */
FOUNDATION_EXPORT MWImageCoderOption _Nonnull const MWImageCoderEncodeCompressionQuality;
...
/**
 ...
 @note works for `MWImageCoder`
 */
FOUNDATION_EXPORT MWImageCoderOption _Nonnull const MWImageCoderEncodeBackgroundColor;
...
/**
 ...
 @note works for `MWImageCoder`
 */
FOUNDATION_EXPORT MWImageCoderOption _Nonnull const MWImageCoderEncodeMaxFileSize;
...
/**
 ...
 @note works for `MWImageCoder`
 */
FOUNDATION_EXPORT MWImageCoderOption _Nonnull const MWImageCoderEncodeEmbedThumbnail;

/**
 A MWWebImageContext object which hold the original context options from top-level API. (MWWebImageContext)
 ...
 See `MWWebImageContext` for more detailed information.
 */
FOUNDATION_EXPORT MWImageCoderOption _Nonnull const MWImageCoderWebImageContext API_DEPRECATED("The coder component will be seperated from Core subspec in the future. Update your code to not rely on this context option.", macos(10.10, API_TO_BE_DEPRECATED), ios(8.0, API_TO_BE_DEPRECATED), tvos(9.0, API_TO_BE_DEPRECATED), watchos(2.0, API_TO_BE_DEPRECATED));;
 ...
 */
@protocol MWImageCoder <NSObject>
...
/**
 ...
 @note This protocol may supports decode animated image frames. You can use `+[MWImageCoderHelper animatedImageWithFrames:]` to produce an animated image with frames.

 @param data The image data to be decoded
 @param options A dictionary containing any decoding options. Pass @{MWImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for image. Pass @{MWImageCoderDecodeFirstFrameOnly: @(YES)} to decode the first frame only.
 @return The decoded image from data
 */
- (nullable UIImage *)decodedImageWithData:(nullable NSData *)data
                                   options:(nullable MWImageCoderOptions *)options;

#pragma mark - Encoding

/**
 Returns YES if this coder can encode some image. Otherwise, it should be passed to another coder.
 For custom coder which introduce new image format, you'd better define a new `MWImageFormat` using like this. If you're creating public coder plugin for new image format, also update `https://github.com/rs/MWWebImage/wiki/Coder-Plugin-List` to avoid same value been defined twice.
 * @code
 static const MWImageFormat MWImageFormatHEIF = 10;
 * @endcode
 
 @param format The image format
 @return YES if this coder can encode the image, NO otherwise
 */
- (BOOL)canEncodeToFormat:(MWImageFormat)format NS_SWIFT_NAME(canEncode(to:));

/**
 Encode the image to image data.
 @note This protocol may supports encode animated image frames. You can use `+[MWImageCoderHelper framesFromAnimatedImage:]` to assemble an animated image with frames.

 @param image The image to be encoded
 @param format The image format to encode, you should note `MWImageFormatUndefined` format is also  possible
 @param options A dictionary containing any encoding options. Pass @{MWImageCoderEncodeCompressionQuality: @(1)} to specify compression quality.
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image
                                   format:(MWImageFormat)format
                                  options:(nullable MWImageCoderOptions *)options;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol MWProgressiveImageCoder <MWImageCoder>
...
/**
 ...
 @param options A dictionary containing any progressive decoding options (instance-level). Pass @{MWImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for progressive animated image (each frames should use the same scale).
 @return A new instance to do incremental decoding for the specify image format
 */
- (nonnull instancetype)initIncrementalWithOptions:(nullable MWImageCoderOptions *)options;
...
/**
 ...
 @note Due to the performance issue for progressive decoding and the integration for image view. This method may only return the first frame image even if the image data is animated image. If you want progressive animated image decoding, conform to `MWAnimatedImageCoder` protocol as well and use `animatedImageFrameAtIndex:` instead.

 @param options A dictionary containing any progressive decoding options. Pass @{MWImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for progressive image
 @return The decoded image from current data
 */
- (nullable UIImage *)incrementalDecodedImageWithOptions:(nullable MWImageCoderOptions *)options;

@end

#pragma mark - Animated Image Provider
/**
 This is the animated image protocol to provide the basic function for animated image rendering. It's adopted by `MWAnimatedImage` and `MWAnimatedImageCoder`
 */
@protocol MWAnimatedImageProvider <NSObject>
...
/**
 This is the animated image coder protocol for custom animated image class like  `MWAnimatedImage`. Through it inherit from `MWImageCoder`. We currentlly only use the method `canDecodeFromData:` to detect the proper coder for specify animated image format.
 */
@protocol MWAnimatedImageCoder <MWImageCoder, MWAnimatedImageProvider>
...
/**
 ...
 After the instance created, we may call methods in `MWAnimatedImageProvider` to produce animated image frame.

 @param data The animated image data to be decode
 @param options A dictionary containing any animated decoding options (instance-level). Pass @{MWImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for animated image (each frames should use the same scale).
