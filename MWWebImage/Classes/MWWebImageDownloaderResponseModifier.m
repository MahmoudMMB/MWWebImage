...
@interface MWWebImageDownloaderResponseModifier ()

@property (nonatomic, copy, nonnull) MWWebImageDownloaderResponseModifierBlock block;

@end

@implementation MWWebImageDownloaderResponseModifier

- (instancetype)initWithBlock:(MWWebImageDownloaderResponseModifierBlock)block {
    self = [super init];
    if (self) {
        self.block = block;
    }
...
+ (instancetype)responseModifierWithBlock:(MWWebImageDownloaderResponseModifierBlock)block {
    MWWebImageDownloaderResponseModifier *responseModifier = [[MWWebImageDownloaderResponseModifier alloc] initWithBlock:block];
...
@implementation MWWebImageDownloaderResponseModifier (Conveniences)
