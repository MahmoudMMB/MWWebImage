...
/**
 ...
 For the description about these methods, see `MWWebImageDownloaderOperation`
 ...
 */
@protocol MWWebImageDownloaderOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
@required
...
/**
 The download operation class for MWWebImageDownloader.
 */
@interface MWWebImageDownloaderOperation : NSOperation <MWWebImageDownloaderOperation>
 ...
 */
@property (assign, nonatomic, readonly) MWWebImageDownloaderOptions options;

/**
 * The context for the receiver.
 */
@property (copy, nonatomic, readonly, nullable) MWWebImageContext *context;

/**
 *  Initializes a `MWWebImageDownloaderOperation` object
 *
 *  @see MWWebImageDownloaderOperation
 *
...
- (nonnull instancetype)initWithRequest:(nullable NSURLRequest *)request
                              inSession:(nullable NSURLSession *)session
                                options:(MWWebImageDownloaderOptions)options
                                context:(nullable MWWebImageContext *)context NS_DESIGNATED_INITIALIZER;
