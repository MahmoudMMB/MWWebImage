...
typedef NS_ENUM(NSInteger, MWWebImageDownloaderExecutionOrder) {
    /**
     * Default value. All download operations will execute in queue style (first-in-first-out).
     */
    MWWebImageDownloaderFIFOExecutionOrder,
    
    /**
     * All download operations will execute in stack style (last-in-first-out).
     */
    MWWebImageDownloaderLIFOExecutionOrder
};
 ...
 */
@interface MWWebImageDownloaderConfig : NSObject <NSCopying>

/**
 Gets the default downloader config used for shared instance or initialization when it does not provide any downloader config. Such as `MWWebImageDownloader.sharedDownloader`.
 ...
 */
@property (nonatomic, class, readonly, nonnull) MWWebImageDownloaderConfig *defaultDownloaderConfig;
...
/**
 * Gets/Sets a subclass of `MWWebImageDownloaderOperation` as the default
 * `NSOperation` to be used each time MWWebImage constructs a request
 * operation to download an image.
 * Defaults to nil.
 * @note Passing `NSOperation<MWWebImageDownloaderOperation>` to set as default. Passing `nil` will revert to `MWWebImageDownloaderOperation`.
 */
@property (nonatomic, assign, nullable) Class operationClass;

/**
 * Changes download operations execution order.
 * Defaults to `MWWebImageDownloaderFIFOExecutionOrder`.
 */
@property (nonatomic, assign) MWWebImageDownloaderExecutionOrder executionOrder;
