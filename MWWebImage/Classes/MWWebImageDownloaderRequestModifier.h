...
typedef NSURLRequest * _Nullable (^MWWebImageDownloaderRequestModifierBlock)(NSURLRequest * _Nonnull request);
 ...
 */
@protocol MWWebImageDownloaderRequestModifier <NSObject>
 ...
 */
@interface MWWebImageDownloaderRequestModifier : NSObject <MWWebImageDownloaderRequestModifier>

/// Create the request modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull MWWebImageDownloaderRequestModifierBlock)block;

/// Create the request modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)requestModifierWithBlock:(nonnull MWWebImageDownloaderRequestModifierBlock)block;
...
*/
@interface MWWebImageDownloaderRequestModifier (Conveniences)
