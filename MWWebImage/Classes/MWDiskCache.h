...
/**
 A protocol to allow custom disk cache used in MWImageCache.
 */
@protocol MWDiskCache <NSObject>
 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull MWImageCacheConfig *)config;
 ...
 */
@interface MWDiskCache : NSObject <MWDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) MWImageCacheConfig *config;
