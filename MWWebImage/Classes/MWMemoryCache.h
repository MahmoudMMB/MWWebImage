...
@class MWImageCacheConfig;
/**
 A protocol to allow custom memory cache used in MWImageCache.
 */
@protocol MWMemoryCache <NSObject>
 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull MWImageCacheConfig *)config;
 ...
 */
@interface MWMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <MWMemoryCache>

@property (nonatomic, strong, nonnull, readonly) MWImageCacheConfig *config;
