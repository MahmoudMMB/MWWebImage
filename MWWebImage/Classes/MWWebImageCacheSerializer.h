...
typedef NSData * _Nullable(^MWWebImageCacheSerializerBlock)(UIImage * _Nonnull image, NSData * _Nullable data, NSURL * _Nullable imageURL);
 ...
 */
@protocol MWWebImageCacheSerializer <NSObject>
 ...
 */
@interface MWWebImageCacheSerializer : NSObject <MWWebImageCacheSerializer>

- (nonnull instancetype)initWithBlock:(nonnull MWWebImageCacheSerializerBlock)block;
+ (nonnull instancetype)cacheSerializerWithBlock:(nonnull MWWebImageCacheSerializerBlock)block;
