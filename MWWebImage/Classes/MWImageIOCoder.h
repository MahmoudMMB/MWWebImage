...
/**
 ...
 For a full GIF support, we recommend `MWAnimatedImageView` to keep both CPU and memory balanced.
 ...
 */
@interface MWImageIOCoder : NSObject <MWProgressiveImageCoder>

@property (nonatomic, class, readonly, nonnull) MWImageIOCoder *sharedCoder;
