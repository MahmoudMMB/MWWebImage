 ...
 */
FOUNDATION_EXPORT NSString * _Nullable MWTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);
...
/**
 ...
 @note If you have both transformer and thumbnail applied for image, call `MWThumbnailedKeyForKey` firstly and then with `MWTransformedKeyForKey`.`
 */
FOUNDATION_EXPORT NSString * _Nullable MWThumbnailedKeyForKey(NSString * _Nullable key, CGSize thumbnailPixelSize, BOOL preserveAspectRatio);

/**
 A transformer protocol to transform the image load from cache or from download.
 You can provide transformer to cache and manager (Through the `transformer` property or context option `MWWebImageContextImageTransformer`).
 
 @note The transform process is called from a global queue in order to not to block the main queue.
 */
@protocol MWImageTransformer <NSObject>
 ...
 */
@interface MWImagePipelineTransformer : NSObject <MWImageTransformer>

/**
 All transformers in pipeline
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<MWImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<MWImageTransformer>> *)transformers;
 ...
 */
@interface MWImageRoundCornerTransformer: NSObject <MWImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) MWRectCorner corners;
...
- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithRadius:(CGFloat)cornerRadius corners:(MWRectCorner)corners borderWidth:(CGFloat)borderWidth borderColor:(nullable UIColor *)borderColor;
 ...
 */
@interface MWImageResizingTransformer : NSObject <MWImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) MWImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(MWImageScaleMode)scaleMode;
 ...
 */
@interface MWImageCroppingTransformer : NSObject <MWImageTransformer>
 ...
 */
@interface MWImageFlippingTransformer : NSObject <MWImageTransformer>
 ...
 */
@interface MWImageRotationTransformer : NSObject <MWImageTransformer>
 ...
 */
@interface MWImageTintTransformer : NSObject <MWImageTransformer>
 ...
 */
@interface MWImageBlurTransformer : NSObject <MWImageTransformer>
 ...
 */
@interface MWImageFilterTransformer: NSObject <MWImageTransformer>
